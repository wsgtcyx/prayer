...
const UseCases = () => (
  <div className="w-full max-w-5xl p-6 bg-white dark:bg-gray-800 rounded-xl shadow mb-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {useCaseItems.map((item, index) => (
        <div key={index} className="flex flex-col items-center p-6 bg-gray-100 dark:bg-gray-700 rounded-xl shadow">
